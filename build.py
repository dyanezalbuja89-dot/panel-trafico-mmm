...
<main>
  ...
  <section id="tab-comp-imp" class="tab-panel">
    ...
    <div id="comp-imp-content" style="display:none">
      ...
      <!-- INSIGHTS -->
      <div class="ford-section" style="margin-top:18px">
        <h3>💡 Oportunidades y hallazgos automáticos</h3>
        <div id="comp-imp-insights"></div>
      </div>
...
(function(){
  ...
  function renderCompImp(){
    ...
    insWrap.innerHTML = C.insights.map(ins=>{
      let cls = 'info';
      if(ins.tipo === 'lanzamiento')      cls = 'good';
      else if(ins.tipo === 'ascenso')     cls = 'good';
      else if(ins.tipo === 'caida')       cls = 'warn';
      else if(ins.tipo === 'oportunidad_qm') cls = 'warn';
      else if(ins.tipo === 'fortaleza_orgu') cls = 'good';
